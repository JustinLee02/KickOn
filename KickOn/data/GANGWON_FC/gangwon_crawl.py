...
def crawl_transfermarkt_gangwon():
    ...
    try:
        url = "https://www.transfermarkt.com/gangwon-fc/startseite/verein/21459"
        driver.get(url)
        time.sleep(10)
    ...
    output_file = "transfermarkt_gangwon_output.csv"
