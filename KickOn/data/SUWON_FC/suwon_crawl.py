...
def crawl_transfermarkt_suwon():
    ...
    try:
        url = "https://www.transfermarkt.com/suwon-fc/startseite/verein/31622"
        driver.get(url)
        time.sleep(10)
    ...
    output_file = "transfermarkt_suwon_output.csv"
