...
def crawl_transfermarkt_pohang():
    ...
    try:
        url = "https://www.transfermarkt.com/pohang-steelers/startseite/verein/311"
        driver.get(url)
        time.sleep(10)
    ...
    output_file = "transfermarkt_pohang_output.csv"
